...
#define DIRECT_CMD4						0x0000d328

#define CTRL_ZQ_MODE_NOTERM				(0x1 << 0)
#define CTRL_ZQ_START					(0x1 << 1)
#define CTRL_ZQ_DIV						(0 << 4)
#define CTRL_ZQ_MODE_DDS				(0x5 << 8) //40ohm
#define CTRL_ZQ_MODE_TERM				(0x2 << 11) //60ohm
...
#define DIV_PIPE						(1 << 3)
#define AWR_ON							(1 << 4)
#define AREF_DISEN						(0 << 5)
#define CON_DRV_TYPE					(3 << 6)
...
#define CHIP_MASK						(0x80 << 16) //0x3FFF_FFFF
#define CHIP0_BASE						(0x40 << 24) //0x4000_0000 - 0x7FFF_FFFF = 1GByte
#define CHIP1_BASE						(0x40 << 24) //0x8000_0000 - 0xBFFF_FFFF = 1GByte
